...
from claude_code_proxy.exceptions import TaskExecutionError
...
class PoolStatsTask(BaseScheduledTask):
    ...
    def _collect_general_pool_stats(self) -> dict[str, Any] | None:
        ...
        return self._format_general_pool_stats(general_pool, general_stats)
    ...
    def _format_general_pool_stats(
        ...
        Args:
            ...
            general_stats: Stats object from pool
        ...
        return {
            ...
            "active_clients": general_stats.active_clients if general_stats else 0,
            ...
            "acquire_count": general_stats.acquire_count if general_stats else 0,
            "release_count": general_stats.release_count if general_stats else 0,
    ...
    async def _collect_session_pool_stats(self) -> dict[str, Any] | None:
        ...
        return self._format_session_pool_stats(session_stats)
    ...
    async def run(self) -> bool:
        ...
        try:
            ...
            general_pool_stats = self._collect_general_pool_stats()
            session_pool_stats = await self._collect_session_pool_stats()

            logger.debug(
                "pool_stats_report",
                task_name=self.name,
                general_pool=general_pool_stats,
                session_pool=session_pool_stats,
            )
