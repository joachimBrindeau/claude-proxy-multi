...
from claude_code_proxy.claude_sdk.stream_handle import StreamHandle
...
from claude_code_proxy.models.claude_sdk import SDKMessage
...
class ClaudeSDKClient:
    ...
    async def _handle_sdk_exceptions(
        ...
        try:
            ...
            raise ServiceUnavailableError(f"Claude CLI not available: {e!s}") from e
            ...
            raise CCProxyError(
                message=f"Claude process error: {e!s}",
