...
All endpoints return Content-Type: application/health+json per IETF spec.
"""
...
async def _check_oauth2_credentials() -> tuple[str, dict[str, Any]]:
    ...
    try:
        ...
        return "fail", {
            "auth_status": "error",
            "error": f"Credentials access error: {e!s}",
        }
    ...
    try:
        ...
        result = (
            "fail",
            {
                ...
                "cli_status": "error",
                "error": f"Failed to execute claude command: {e!s}",
                "version": None,
                "binary_path": claude_path,
            },
        )
...
async def _check_claude_sdk() -> tuple[str, dict[str, Any]]:
    ...
    try:
        ...
        return "warn", {
            ...
            "error": f"Claude SDK not available: {e!s}",
            "version": None,
