...
class OAuthSettings(BaseModel):
    ...
    Uses shared constants from claude_code_proxy.auth.oauth.constants to ensure
...
class CredentialStorageSettings(BaseModel):
    ...
    credentials_dir: Path = Field(
        default=Path("~/.config/claude-code-proxy").expanduser(),
        description="Directory for storing credentials and API keys",
    )
