...
from claude_code_proxy.cli.helpers import (
    get_rich_toolkit,
...
from claude_code_proxy.core.async_utils import get_root_package_name
...
def _run_docker_server(
    ...
    Coordinates Docker server startup by:
    1. Building environment variables from settings and CLI overrides
    2. Displaying configuration summary for user visibility
    3. Creating Docker adapter configuration
    4. Executing the container with configured settings
    """
    from .docker_server_helpers import (
        build_docker_environment,
        create_docker_configuration,
        display_docker_configuration,
    ...
    docker_env_dict = build_docker_environment(settings, docker_env)
    ...
    # Create Docker adapter configuration
    ...
    try:
        ...
        if docker:
            ...
            try:
                ...
                # nosec B606 - safe: controlled path from settings, no shell involved
